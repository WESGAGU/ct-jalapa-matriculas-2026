...
const styles = StyleSheet.create({
  ...
  // Contenedor para la sección de información superior
  topInfoContainer: {
    marginBottom: 15,
  },
  
  // Estilo para las filas de información superior
  infoRow: {
    flexDirection: 'row',
    marginBottom: 5,
    alignItems: 'flex-end',
  ...
  // Estilo para los valores con borde inferior más delgado
  infoValue: {
    flex: 1,
    borderBottomWidth: 0.5,  // Borde más delgado
    borderBottomColor: '#000',
    paddingBottom: 1,        // Reducir padding para hacerlo más compacto
    fontSize: 9,
    marginRight: 10,         // Espacio entre campos
  },
  
  // Estilo para la segunda fila (FECHA, CORREO, CONTRASEÑA)
  secondInfoRow: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    marginBottom: 5,
  ...
  // Contenedor para fecha y correo
  dateEmailContainer: {
    flexDirection: 'row',
    alignItems: 'flex-end',
    width: '65%',
  ...
  footer: { position: 'absolute', bottom: 40, left: 40, right: 40, display: 'flex', flexDirection: 'row', justifyContent: 'space-around', paddingTop: 30, textAlign: 'center', fontSize: 10 },
  signatureLine: { borderTopWidth: 1, borderTopColor: '#333', paddingTop: 5, width: 200 },

  // Estilos para las páginas de imágenes
  imagePage: {
    padding: 40,
    display: 'flex',
  ...
  <Document>
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.topInfoContainer}>
        ...
        {/* Fila para FECHA, CORREO y CONTRASEÑA */}
    ...
    {/* --- Página 3: certificado de nacimiento --- */}
